name "Multi Cloud Account Creator - Module 3 - <USER>"
rs_ca_ver 20161221
short_description "Creates a Cloud Tenant in AWS, Azure, or GCP and moves it to the correct organizational unit."
import "sys_log"
